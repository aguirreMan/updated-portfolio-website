  ...
  return (
    <div className='flex flex-col gap-14'>
      <CaseStudyHeader
        ...
        title='Gorilla AI'
        description='An agentic Ai tool that accelerates users learning technical topics fast'
        stack={stack}
      ...
      >
        <p className='text-muted-foreground leading-7 max-w-2xl'>
          ...
          no real way to differentiate. I scrapped my codebase to replace lines of image generation code and
          reframed the product entirely around learning. The infrastructure I'd already built —
          auth, database schema, streaming architecture — carried over. The product idea was wrong,
          not the engineering.
        </p>
      </CaseStudySection>

      <CaseStudySection title='evolution'
      ...
      >
        <p className='text-muted-foreground leading-7 max-w-2xl'>
          ...
          to do. Image generation is stateless you make a request, you get an image, save to database and done. A chat
          product is fundamentally stateful. It needs to track conversations, stream responses in real time,
          persist history per user, and handle things like cancellation mid-stream. That meant the
          architecture had to evolve from a simple request/response model into something that could
          manage ongoing state across a session. Every major technical decision I made came out of
          that shift.
        </p>
      </CaseStudySection>
      ...
      <CaseStudySection title='differently' description='Things i would do differently if i started over today'>
        <p className='text-muted-foreground leading-7'>
