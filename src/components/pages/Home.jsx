  ...
  return (
    <div className='h-screen w-full absolute inset-0 bg-background/60'>
      ...
      <div className='relative z-10 flex flex-col items-center justify-center h-full text-center'>
        ...
        <p className='text-foreground text-3xl mt-4 font-medium pb-6 
        tracking-wide'>Frontend Engineer building scalable, polished Web applications</p>
        <Link to='/contact'><Button size='lg'>
